...
<iframe src="https://csb-dwwj6.netlify.app/"
style={{width:"700px", height:"770px", border:"1px solid", overflowX: 'hidden',
overflowY: 'hidden'}}
...
<br/>
          <div class="post-content inner-sm" style={{textAlign:'center'}}>
              ...
              <iframe src="https://csb-3mjet.netlify.app/"
     style={{width:"100%", height:"600px", border:"1px solid", overflowX: 'hidden',
     overflowY: 'hidden'}}
